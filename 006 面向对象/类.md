...
![截屏2020-02-0216.28.49](/Users/gregoryshen/截图/截屏2020-02-0216.28.49.png)
...
![截屏2020-02-0122.22.02](/Users/gregoryshen/截图/截屏2020-02-0122.22.02.png)
...
![截屏2020-02-0121.09.25](/Users/gregoryshen/截图/截屏2020-02-0121.09.25.png)
...
![截屏2020-02-0118.12.55](/Users/gregoryshen/截图/截屏2020-02-0118.12.55.png)
...
![截屏2020-01-3121.38.33](/Users/gregoryshen/截图/截屏2020-01-3121.38.33.png)
...
![截屏2020-01-3019.00.49](/Users/gregoryshen/截图/截屏2020-01-3019.00.49.png)
...
![截屏2020-01-3019.17.24](/Users/gregoryshen/截图/截屏2020-01-3019.17.24.png)
...
![截屏2020-01-3022.05.58](/Users/gregoryshen/截图/截屏2020-01-3022.05.58.png)

这里就引发了之前说的无限递归的问题,

改回成正确的写法: `self.__dict__[key] = value`

![截屏2020-01-3022.09.46](/Users/gregoryshen/截图/截屏2020-01-3022.09.46.png)
...
![截屏2020-01-3022.12.56](/Users/gregoryshen/截图/截屏2020-01-3022.12.56.png)

可以看到又一次引起无限递归

下面尝试`return self.__dict__[key]`

![截屏2020-01-3022.15.16](/Users/gregoryshen/截图/截屏2020-01-3022.15.16.png)
...
![截屏2020-01-3022.19.27](/Users/gregoryshen/截图/截屏2020-01-3022.19.27.png)
...
One use people have found for class methods is to create [inheritable alternative constructors](https://stackoverflow.com/questions/1950414/what-is-the-purpose-of-classmethod-in-this-code/1950927#1950927).

> [What is the purpose of classmethod in this code?](https://stackoverflow.com/questions/1950414/what-does-classmethod-do-in-this-code/1950927#1950927)
>
...
> Comment:
>
> This isn’t an alternative constructor, this is a factory method.
>
> reply: it is a factory method that works as an alternative constructor.
...
## [官网内置函数页面对于classmethod的解释](https://docs.python.org/3/library/functions.html#classmethod)
...
## [官网内置函数页面对于staticmethod的解释](https://docs.python.org/3/library/functions.html#staticmethod)
...
因为通常class的实例都有一个`__dict__`属性，它就是一个dict， 用来存储实例变量。也有少数例外，比如定义了`__slot__`的class。
