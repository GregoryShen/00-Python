...
![截屏2020-01-1217.58.03](/Users/gregoryshen/Desktop/截屏2020-01-1217.58.03.png)

==以`w+`方式打开的时候, 读是什么都没有的,因为以`w+`打开的时候虽然对文件有读写权限但还是会把当前文件清空==

![截屏2020-01-1217.59.48](/Users/gregoryshen/Desktop/截屏2020-01-1217.59.48.png)
...
![截屏2020-01-1222.45.22](/Users/gregoryshen/Desktop/截屏2020-01-1222.45.22.png)
...
os模块,如果使用这种方式,会使我们的程序更加Linux.

`os.open, flag[, mode]`:打开文件
